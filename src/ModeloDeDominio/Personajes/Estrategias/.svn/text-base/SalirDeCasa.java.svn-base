...
public class SalirDeCasa extends Cazar {

	@Override
	public Direccion haciaDondeIrDesdePosicionConDireccionActual(Posicion desdeDonde,
			Direccion direccionActual) {
		return super.haciaDondeIrDesdeUnaPosicionHastaOtraConDireccionActual(JuegoConcreto.getInstancia().getLaberinto().getPuertaDeLaCasaDeLosFantasmitas(), desdeDonde, direccionActual);
	}
